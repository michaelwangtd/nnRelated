...
if __name__ == '__main__':
    ...
    orderedDic = convert2SortedDic(initDic)
    print('排序字典完成...')
    # exit(0)

    # print(len(orderedDic))
    ...
    i = 1
    for neStr,relationAndIndexTupeList in orderedDic.items():
        if relationAndIndexTupeList:

            relationWordList = []
            sentenceIndexList = []

            for item in relationAndIndexTupeList:
                relationWordList.append(item[0])
                sentenceIndexList.append(item[1])
            ...
            # print(type(neStr),neStr)
            # print(type(candidateRelationStr),candidateRelationStr)
            # print(type(sentenceIndexList),sentenceIndexList)
            # print(type(outputRelationWordSortedList),outputRelationWordSortedList)
            # print(type(sentenceOutputStr),sentenceOutputStr)
            # exit(0)
